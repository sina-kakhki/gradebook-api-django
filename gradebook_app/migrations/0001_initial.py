    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gradebook_app.class')),
                ('studentID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gradebook_app.student')),
            ],
        ),
        migrations.CreateModel(
            name='Lecturer',
        ...
        migrations.AddField(
            model_name='course',
            name='semester',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='gradebook_app.semester'),
        ),
        migrations.AddField(
            model_name='class',
            name='course',
        ...
        migrations.AddField(
            model_name='class',
            name='students',
            field=models.ManyToManyField(to='gradebook_app.student'),
        ),
    ]
